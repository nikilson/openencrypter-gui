...
def Reader(password, mydirectory):
    ...
    clip_btn = tkinter.Button(open_encrypter_gui, bg="#20bebe", fg="white", width=20, padx=2, pady=2, font=("Arial", 18), text="Copy to Clipboard", command=lambda: butn_decrypt("y"))
    clip_btn.grid(row=4, column=2)
    show_btn = tkinter.Button(open_encrypter_gui, bg="#20bebe", fg="white", width=20, padx=2, pady=2, font=("Arial", 18), text="Show Everything", command=lambda: butn_decrypt("n"))
