...
def datawriter(user_name, user_key, directory):
    ...
    submit_pass_btn = tkinter.Button(open_encrypter_gui, bg="#20bebe", fg="white", width=20, padx=2, pady=2, font=("Arial", 18), text="Write Password", command=lambda: password_collect_service())
    submit_text_btn = tkinter.Button(open_encrypter_gui, bg="#20bebe", fg="white", width=20, padx=2, pady=2, font=("Arial", 18), text="Write Text", command=lambda: my_text_writer())
    exit_btn = tkinter.Button(open_encrypter_gui, bg="#20bebe", fg="white", width=20, padx=2, pady=2, font=("Arial", 18), text="Exit", command=lambda: my_exit())
